...
void URender()
{
    // Lamp orbits around the origin y-axis (0.0f, 1.0f, 0.0f), the position is then updated to the newPosition
    // given the angularVelocity and gDeltaTime, then multiplied by the gLightPosition.
