...
namespace
{
    const char* const WINDOW_TITLE = "Module6_Pyramid_Light_MarkJumper"; // Macro for window title
    ...
    // Light Position and Scale
    glm::vec3 gLightPosition2(-1.5f, 2.5f, -3.0f);
...
int main(int argc, char* argv[])
{
    ...
    // Load texture
    const char* texFilename = "C:/textures/gravel.jpg";
...
void URender()
{
    ...
    /*
    // Second Lamp - before binding scale and texture
    // Reference matrix uniforms from the Cube Shader program for the cub color, light color, light position, and camera position
    GLint objectColorLoc2 = glGetUniformLocation(gProgramId, "objectColor");
    GLint lightColorLoc2 = glGetUniformLocation(gProgramId, "lightColor");
    GLint lightPositionLoc2 = glGetUniformLocation(gProgramId, "lightPos");
    GLint viewPositionLoc2 = glGetUniformLocation(gProgramId, "viewPosition");
    ...
    glUniform3f(viewPositionLoc2, cameraPosition2.x, cameraPosition2.y, cameraPosition2.z);
    */
    ...
    // Draws the triangles for object
    ...
    // draw triangles for second lamp
    glDrawArrays(GL_TRIANGLES, 0, gMesh.nVertices);
    */
